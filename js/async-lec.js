...
`, options)
    ...
    .then(response => getSanitizedResponse(response)) // makes new objects with only needed data (that i want)
    .then(sres => renderDailyForecast(sres)) //use new objects to render dom nodes and append to dom
